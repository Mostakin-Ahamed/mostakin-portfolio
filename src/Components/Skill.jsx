    ...
    return (
        ...
        <div>
            ...
            <Slide direction="right">
                <div className="w-9/12 mx-auto  mb-9 flex justify-evenly  gap-5 object-contain ">
                    <div>
                        <img className='h-[100px]  object-cover ' src="/css.svg" alt="" />
                    </div>
                    <div>
                        <img className='h-[100px] w-2/3 ' src="/daisyUi.svg" alt="" />
                    </div>
                    <div>
            ...
            <Slide direction="left">
                <div className="w-9/12 mx-auto mt-9 flex justify-evenly  gap-5 object-contain">
                    <div>
