        ...
        <div className="flex items-center justify-center py-12">
            <div className="bg-white rounded-md flex items-center justify-center mx-4 md:w-2/3">
                <div className="flex flex-col items-center py-16">
                    ...
                    <p className="px-4 pb-10 text-base  text-center text-gray-600">
                        No signal here!
                    </p>
                    <Link to="/">
                        <button className="mx-4 h-10 w-44  rounded-md text-white text-base bg-indigo-700 hover:bg-indigo-800 ">
                            Go Back
                        </button>
                    </Link>
                </div>
